...
@Component({
  ...
  template: `
    ...
    @else {
      <div class="flex items-center gap-2 border border-red-200 rounded-lg px-3 py-3 bg-white w-full danger"> 
        <mat-icon class="small"> warning </mat-icon>
        <span class="text-xs">This item is currently out of stock. Add it to your wishlist to be notified when it's back in stock.</span>
      </div>
    }
  `,
  styles: ``,
